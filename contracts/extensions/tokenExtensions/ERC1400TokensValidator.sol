...
import "contracts/helpers/SafeMath.sol";
import "contracts/helpers/Ownable.sol";
import "contracts/helpers/Pausable.sol";
import "contracts/helpers/Whitelist.sol";
import "contracts/helpers/IERC20.sol";

import "./roles/BlacklistedRole.sol";

import "contracts/helpers/ERC1820Client.sol";
...
contract ERC1400TokensValidator is IERC1400TokensValidator, Ownable, Pausable,  BlacklistedRole, ERC1820Client, ERC1820Implementer {
